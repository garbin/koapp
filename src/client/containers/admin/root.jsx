                ...
                <ul className="nav-profile">
                  <Dropdown.Wrapper tag="li" className="profile dropdown open">
                    ...
                    <Dropdown.Menu className="dropdown-menu profile-dropdown-menu">
                      <a href="#" className="dropdown-item"> <i className="fa fa-user icon"></i> Profile </a>
                      <a className="dropdown-item"> <i className="fa fa-bell icon"></i> Notifications </a>
                      <a className="dropdown-item"> <i className="fa fa-gear icon"></i> Settings </a>
